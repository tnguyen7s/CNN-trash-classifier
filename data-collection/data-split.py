...
DATASET_FOLDER = './collected-datasets/All'
...
# split train-val-test to be 50-25-25
for c in CATEGORIES:
    ...
    persplit_count = math.ceil(image_count/4)
    train_split = (image_files[0:persplit_count*2], TRAIN_FOLDER)
    val_split = (image_files[persplit_count*2: persplit_count*3], VAL_FOLDER)
    test_split = (image_files[persplit_count*3: image_count], TEST_FOLDER)
